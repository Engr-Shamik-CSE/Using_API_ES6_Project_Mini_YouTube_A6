...
const displayVideos = (videos) => {
  ...
  if (videos.length == 0) {
    videoContainer.innerHTML = `
    <div class="col-span-4 flex justify-center items-center min-h-[80vh]">
    ...
    videoCard.innerHTML = `
      <div class="card bg-base-100 shadow-sm gap-5 flex items-center">
            <figure class="relative ">
                <img class="rounded-lg h-[170px] w-[350px] object-cover" src="${video.thumbnail}" alt="thumbnal-image" />
